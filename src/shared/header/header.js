...
import { PiNotepad, PiUser, PiDesktopLight } from "react-icons/pi";
      ...
      <header className={Styles.header}>
        ...
        <div className={Styles.headerWrapper}>
          <div className={Styles.headerWrapper__inWrapper}>
            ...
            <ul
              className={`${Styles.headerWrapper__Menu} ${
                isActive ? Styles.openMenu : ""
              }`}
            >
              <li className={`${Styles.headerWrapper__menuList}`} onClick={toggleClass}>
                <Link
                  href={"/about"}
                  className={`${
